    ...
    return (
        <div className='px-[25px] pt-[25px] bg-[#F8F9FC] pb-[40px]'>
            ...
            <div className='grid grid-cols-2 gap-[30px] mt-[25px] pb-[15px]'>
                <div className=' h-24 rounded-[8px] bg-white border-l-[4px] border-[#4E73DF] flex items-center justify-between px-[30px] cursor-pointer hover:shadow-lg transform hover:scale-[103%] transition duration-300 ease-out' onClick={toggleAnalytics}>
                    <div>
                ...
                <div className=' h-24 rounded-[8px] bg-white border-l-[4px] border-[#1CC88A] flex items-center justify-between px-[30px] cursor-pointer hover:shadow-lg transform hover:scale-[103%] transition duration-300 ease-out' onClick={toggleSearch}>
                    <div>
