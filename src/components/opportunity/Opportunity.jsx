        ...
        {opportunity &&
            <div className='px-64 pt-20 pb-[40px]'>
                <div className='rounded-[18px] flex flex-col items-center justify-between shadow-md bg-white p-8'>
                    ...
                    {loggedUser && loggedUser.type !== opportunity.publisher.type.toLowerCase() &&
                        <div className='flex justify-center mb-8'>
                            <button className='bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-[8px]' onClick={""}>Apply</button>
                        </div>
                    }
                    <div className="grid grid-cols-4 gap-x-4">
                        <div className='col-span-4 mb-8' onClick={() => navigateToUser(opportunity.publisher.type.toLowerCase(), opportunity.publisher._id)}>
                            ...
                            <div className='relative rounded-[8px] cursor-pointer border-t-[4px] border-red-400 inline-flex items-center justify-center shadow-md hover:shadow-lg transform hover:scale-[103%] transition duration-300 ease-out py-2 px-14'>
                        ...
                        <div className="col-span-4 flex-col mb-8">
                            ...
                            <div className="flex flex-wrap gap-x-4 gap-y-2">
                                {opportunity?.applications.map((application, index) => (
                                    <div key={index} className={`rounded-[8px] cursor-default border-t-[4px] ${application.status ? "border-green-300" : "border-orange-300"} flex flex-col items-center justify-center shadow-md hover:shadow-lg transform hover:scale-[103%] transition duration-300 ease-out px-8 py-4`}>
